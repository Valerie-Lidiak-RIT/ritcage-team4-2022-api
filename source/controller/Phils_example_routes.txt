  ...
  static async register(app: Express) {
    ...
    app.post("/api/v1/Model", async (req, res) => {
      ...
      let newModel = await Model.create({
        ...
        restrictionsModelsId: req.body.restrictionsModelsId,
      }).save();
      res.send(newModel);
    });
    ...
    app.patch("/api/v1/Model/:id", async (req, res) => {
      ...
      if (wantedModel == null) {
        ...
        wantedModel.description =
          req.body.description || wantedModel.description;
        ...
        wantedModel.restrictionsModelsId =
          req.body.restrictionsModelsId || wantedModel.restrictionsModelsId;
